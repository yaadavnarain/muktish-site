    ...
    <AnimatePresence>
      {visible && (
        <motion.a
          ...
          className="fixed bottom-5 right-5 z-40 inline-flex h-12 min-h-[44px] items-center gap-2 rounded-full bg-gold pl-3 pr-4 text-sm font-semibold text-bg shadow-[0_12px_40px_-8px_rgba(245,200,66,0.55)] hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold/70 transition-transform sm:bottom-7 sm:right-7"
        >
